...
files = ['config.py', 'edit_menu.py', 'help_menu.py', 'file_menu.py', 'format_menu.py', 'LICENSE.txt', 'notepad-main.png', 'setup.exe', 'version.log', 'Backpack_Notepad.exe', 'settings.py', 'notepad-main-shortcut.ico']
