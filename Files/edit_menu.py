...
def main(root, text, menubar):
    ...
    editmenu.add_command(label="Köçür", command=objEdit.copy, accelerator="Ctrl+C")
    ...
    editmenu.add_command(label="(Redo) Yenidən", command=objEdit.redo, accelerator="Ctrl+Y")
